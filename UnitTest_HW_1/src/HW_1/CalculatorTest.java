...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        // try {
        //     seminars.first.Calculator.Calculator.Calculator.Calculator.calculation(8, 4, '_');
...
//        assertThat(Calculator.Calculator.calculation(2, 6, '+')).isEqualTo(8);
//        assertThat(Calculator.Calculator.calculation(2, 2, '-')).isEqualTo(0);
//        assertThat(Calculator.Calculator.calculation(2, 7, '*')).isEqualTo(14);
//        assertThat(Calculator.Calculator.calculation(100, 50, '/')).isEqualTo(2);

        // Проверка ожидаемого исключения, с использованием утверждений AssertJ:
//        assertThatThrownBy(() -> Calculator.Calculator.calculation(8, 4, '_')).isInstanceOf(IllegalStateException.class);
